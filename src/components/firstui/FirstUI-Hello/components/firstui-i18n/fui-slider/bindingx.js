// 本文件由FirstUI授权予安徽理工大学（会员ID：4 0  34，营业执照号：  12 3 4 0 00 0   4  8  531 99  59Y）专用，请尊重知识产权，勿私下传播，违者追究法律责任。
// #ifdef APP-NVUE
...
export default {
	...
	methods: {
		...
		styleChange(value, isEnd) {
			...
			const maxWidth = Number(this.width) - Number(this.blockWidth);
		...
		touchmove(e) {
			if (this.disabled || this.tEnd) return;
