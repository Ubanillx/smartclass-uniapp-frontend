<template>
	<!--本文件由FirstUI授权予安徽理工大学（会员ID：4   034，营业执照号：  1 2  3400 0 0  4 8 5 31995     9Y）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
	<view class="fui-wrap">
		...
		<view class="fui-page__bd">
			...
			<fui-collapse @change="change" background="transparent">
			...
			<view class="fui-section__title">不显示箭头/margin值</view>
			<fui-collapse accordion @change="change">
				<fui-collapse-item :arrow="false" :index="index" v-for="(item,index) in list" :key="index">
					...
					<template v-slot:content>
						<view class="fui-descr" style="color: #09BE4F;">
							{{item.answer}}
						</view>
					</template>
				</fui-collapse-item>
