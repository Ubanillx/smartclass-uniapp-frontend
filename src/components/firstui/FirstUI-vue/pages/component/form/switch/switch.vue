<template>
	<!--本文件由FirstUI授权予安徽理工大学（会员ID：4 0  34，营业执照号：1   2340      0 0    0485319959   Y）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
	<view class="fui-wrap">
			...
			<fui-label>
				<fui-list-cell>
					<view class="fui-cells">
						...
						<fui-switch :scaleRatio="0.8" background="#f5f5f5" btn-bg-color="#f8f8f8" color="#FFB703"></fui-switch>
					</view>
				</fui-list-cell>
			</fui-label>
