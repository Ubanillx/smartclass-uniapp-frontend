<template>
	<!--本文件由FirstUI授权予安徽理工大学（会员ID： 40  34，营业执照号： 1 2340  00048 53 1  9 95      9  Y）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
	<view class="fui-wrap">
		<view class="fui-page__hd">
			<view class="fui-page__title fui-align__center" @tap="vip">
				<fui-text font-weight="600" size="36" text="Poster"></fui-text>
				<image class="fui-vip__icon" src="/static/images/index/light/icon_member_3x.png"></image>
			</view>
			<text class="fui-page__desc">Poster 分享海报 ，传入JSON数据生成海报。</text>
		</view>
		<view class="fui-page__bd">
			<fui-button type="gray" btn-size="medium" text="基本使用" bold :margin="['24rpx']" @click="poster(1)">
			</fui-button>
		...
		<!-- #ifdef APP-NVUE -->
		<fui-poster-weex ref="generator" :width="560" :height="980" @ready="ready"></fui-poster-weex>
		<!-- #endif -->
		...
		data() {
			return {
				...
				basicData: {
					...
					imgs: [{
						imgResource: 'https://res.firstui.cn/static/images/common/img_logo.png',
						x: 20,
						y: 260,
						width: 100,
						height: 100,
				...
				goodsData: {
					...
					imgs: [{
						imgResource: 'https://res.firstui.cn/static/images/component/img_bg_poster.png',
						x: 0,
						y: 0,
						width: 560,
						height: 800,
						...
						imgResource: 'https://res.firstui.cn/static/images/component/img_goods_3x.jpg',
						x: 56,
						y: 128,
						width: 448,
						height: 448,
						...
						imgResource: 'https://res.firstui.cn/static/images/qrcode/wx_qrcode.jpg',
						x: 378,
						y: 822,
						width: 136,
						height: 136,
