<!--本文件由FirstUI授权予安徽理工大学（会员ID： 4 0 34，营业执照号：1 2 3   40  0     004 8 53 19 9 59Y）专用，请尊重知识产权，勿私下传播，违者追究法律责任。-->
<script>
	import {
		mapMutations
	} from 'vuex'
	export default {
		onLaunch: function() {
			...
			theme = theme || plus.navigator.getUIStyle();// 新特性待增加
